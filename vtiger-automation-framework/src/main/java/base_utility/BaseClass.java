 ...
 *
 * Responsibilities: - @BeforeClass : Launch browser (browser name from
 * commondata.json) - @BeforeMethod : Login to Vtiger CRM (url/un/pwd from
 * commondata.json) - @AfterMethod : Logout from CRM using HomePage POM
